...
const propTypes = {
   ...
   *
   * See https://facebook.github.io/react-native/docs/button.html#props for available props.
   */
            ...
            <View style={styles.pickerContainer}>
              <View style={[styles.pickerHeader, headerStyle]}>
                <TouchableOpacity activeOpacity={0.5} onPress={this.hidePicker}>
                  <Text type="button" style={[styles.button, buttonStyle]} {...buttonProps}>{buttonText}</Text>
                </TouchableOpacity>
              </View>
              <Divider />
              {picker}
