...
const propTypes = {
  ...
  /** Override the styles of the bottom Divider component */
  dividerBottomStyle: ViewPropTypes.style,
  /** Render a Divider above the ListItem */
  dividerTop: PropTypes.bool,
  /** Override the styles of the top Divider component */
  dividerTopStyle: ViewPropTypes.style,
  ...
  return (
    ...
    >
      <View style={[styles.container, style]}>
        {dividerTop ? <Divider style={[styles.dividerTop, dividerTopStyle]} /> : null}
        {
          leftButton
        ...
        {dividerBottom ? <Divider style={[styles.dividerBottom, dividerBottomStyle]} /> : null}
      </View>
    </TouchableHighlight>
  );
};
