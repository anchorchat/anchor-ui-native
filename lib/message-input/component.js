...
const propTypes = {
  ...
  /**
   * Callback fired when Input's text is changed
   *
...
class MessageInput extends Component {
  ...
  render() {
    ...
    return (
      <View style={[styles.container, multiline ? styles.containerMultiline : null, style]} {...custom}>
        {
          leftIcon
        ...
        <TextInput
          ...
          value={value}
          style={[textStyles.body, styles.input, multiline ? styles.inputMultiline : null, inputStyle]}
