...
const propTypes = {
  ...
  type: PropTypes.oneOf(['text', 'image', 'contact', 'video']).isRequired,
  /** Message body text */
  ...
  video: PropTypes.shape({
    source: Image.propTypes.source.isRequired,
    posterSource: Image.propTypes.posterSource,
    ratio: PropTypes.number.isRequired
  }),
  /** Width for landscape videos and height for portrait videos */
  videoSize: PropTypes.number,
  /**
   * Custom props for the Video component for 'video' messages
   *
   * See https://facebook.github.io/react-native/docs/video.html#props for available props.
   */
  videoProps: PropTypes.object, // eslint-disable-line react/forbid-prop-types
  /**
   * Callback fired when Message video is pressed
   *
   * function(event: object) => void
   */
  onVideoPress: PropTypes.func,
  /**
   * Callback fired when Message video is long pressed
   *
   * function(event: object) => void
   */
