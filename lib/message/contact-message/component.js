...
const propTypes = {
  style: ViewPropTypes.style.isRequired, // eslint-disable-line react/forbid-prop-types
    ...
    <View style={[styles.container, style]} {...custom}>
      ...
      <View style={styles.row}>
        ...
        <View style={styles.textContainer}>
          <Text type={align === 'right' ? 'body-contrast' : 'body-light'} {...primaryTextProps}>{contact.primaryText}</Text>
