...
import { View, Image, Animated, Text as NativeText } from 'react-native';
    ...
    return (
      <View style={[styles.root, style]} {...custom}>
        ...
        <View style={[styles.imageContainer, imageContainerStyle]}>
          ...
          <Animated.Image source={source} resizeMode="contain" style={imageStyle} onLoad={this.onImageLoad} {...imageProps} />
        </View>
        <View style={[styles.footer, footerStyle]}>
          {
            ...
            ? (
              <View style={styles.footerDescription}>
                <Text type="body-contrast" numberOfLines={1} style={descriptionFooterTextStyle}>{descriptionFooterText}</Text>
              </View>
            )
            : null
          }
          <View style={styles.footerContainer}>
            <View style={styles.textContainer}>
              <Text type="heading" numberOfLines={1} style={[styles.primaryFooterText, primaryFooterTextStyle]}>
                {primaryFooterText}
              </Text>
              <Text type="heading-secondary" numberOfLines={1} style={[styles.secondaryFooterText, secondaryFooterTextStyle]}>
                {secondaryFooterText}
              </Text>
            </View>
            {leftFooterButton ? <View style={[styles.leftFooterButton, leftFooterButtonStyle]}>{leftFooterButton}</View> : null}
            {rightFooterButton ? <View style={[styles.rightFooterButton, rightFooterButtonStyle]}>{rightFooterButton}</View> : null}
          </View>
        </View>
      </View>
    )
