...
const IconsDoc = () => (
  <section className="page">
    ...
    <span><Text type="body-light">SVG icons from <a href="https://ionicons.com/" target="blank" rel="noopener noreferrer">ionicons</a> in iOS style. All icons are 28pt wide and high.</Text></span>
