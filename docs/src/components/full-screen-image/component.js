...
const componentData = find(components, { displayName: 'FullScreenImage' });

const FullScreenImageDoc = () => (
  <section className="page">
    <h1 className="heading-large">Full Screen Image</h1>
...
export default FullScreenImageDoc;
